...
create_generated_clock -name clk_div2 -source [get_ports clk_i] -divide_by 2 [get_pins clk_div2_reg/Q]
...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {JA[4]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {JA[4]}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {JA[6]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {JA[6]}]
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {JA[1]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {JA[3]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {JA[3]}]
##Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {JA[5]}]					
...
##Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {JXADC[2]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[2]}]
##Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {JXADC[4]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[4]}]
##Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {JXADC[6]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[6]}]
##Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {JXADC[1]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[1]}]
##Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {JXADC[3]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {JXADC[3]}]
##Sch name = XA3_N
set_property PACKAGE_PIN M1 [get_ports {JXADC[5]}]				
